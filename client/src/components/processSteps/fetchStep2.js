...
export default function FetchStep2 (props) {
    ...
    //On first render we need to reload the iframe with the correct proxied URL.
      ...
      return (
        <>
            <h3><i>{instructionText}</i> on the element to scan for changes to.</h3> 
...
function LoadIndicator(props) {
    ...
    return (<div style={{display: (props.hidden) ? "none" : "block"}} id="frameLoadPlaceholder">
        <div id="spacerTop"></div>
            ...
            <p id="loadingMessage">Just loading that page for you; hold on tight.</p>
            <div className="spacer"></div>
            <a href="https://xkcd.com/612/"><img id="XKCD" src="https://imgs.xkcd.com/comics/estimation.png" alt="An XKCD comic about progress estimation; LICENCE: https://creativecommons.org/licenses/by-nc/2.0/legalcode"/></a>
